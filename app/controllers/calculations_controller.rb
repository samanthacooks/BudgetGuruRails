...
#   end
  ...
  def summary
    ...
    if $USER.positive == true && !can_spend? && bills_upcoming_count > 1
      ...
      message = "You have enough to pay week but your total bills within the next week of $#{(remaining_balance_after_charge_account + total_income_by('weekly'))-bills_upcoming_total} but your account is below your desired minimum by $#{floor-remaining_balance}"
